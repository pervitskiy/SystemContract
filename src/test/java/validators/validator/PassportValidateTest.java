...
public class PassportValidateTest extends TestCase {

    Person person1 = new Person(1, "Dima", "Per", "EB", LocalDate.of(2000, 10, 26), Person.Gender.MALE, 2014, 800457);
    Person person2 = new Person(2, "Max", "Lisdf", "HJewrwer", LocalDate.of(2004, 5, 26), Person.Gender.MALE, 20, 800123);
    Person person3 = new Person(3, "Danil", "Petrov", "putins", LocalDate.of(2000, 11, 13), Person.Gender.MALE, 121, 803148);
    ...
    public void testDoValidate() {
        Assert.assertEquals(passportValidate.doValidate(contract1).getStatus(), ValidationStatus.ОК);
        Assert.assertEquals(passportValidate.doValidate(contract4).getStatus(), ValidationStatus.ERROR);
        Assert.assertEquals(passportValidate.doValidate(contract5).getStatus(), ValidationStatus.ERROR);
